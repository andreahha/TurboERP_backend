...
public class SubindiceDiagnostico {
	private int id;
	...
	public SubindiceDiagnostico() {
		super();
	}

	public SubindiceDiagnostico(int id, String descripcion, int lugar, int activo, int creado_por, Date creado,
			int modificado_por, Date modificado, int detalle_diagnostico_id) {
		super();
		this.id = id;
