...
public class DTOrdenes {
	...
	public DTOrdenes(int id, String presion_de_entrada, String presion_de_salida, int activo, int creado_por,
			Date creado, int modificado_por, Date modificado, String temperatura_salida, String temperatura_entrada,
			float capacidad_hp, float capacida_mw, String velocidad_critica, String velocidad_operacion,
	...
	public String toString() {
		return "DTOrdenes [id=" + id + ", presion_de_entrada=" + presion_de_entrada + ", presion_de_salida="
