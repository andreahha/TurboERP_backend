...
public class DetallePrecotizacion {
	private int	id;
	...
	public DetallePrecotizacion() {
		super();
	}

	public DetallePrecotizacion(int id, String descripcion, String tipo_actividad, int lugar, int suministro,
			int planta, int activo, int creado_por, Date creado, int modificado_por, Date modificado,
