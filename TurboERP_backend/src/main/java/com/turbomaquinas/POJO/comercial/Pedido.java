...
public class Pedido {
	...
	public Pedido(int id, String numero, String comentarios, Float importe, int revision, int sustituye_id, int activo,
			int creado_por, Date creado, int modificado_por, Date modificado, String alfresco_id) {
		this.id = id;
		this.numero = numero;
