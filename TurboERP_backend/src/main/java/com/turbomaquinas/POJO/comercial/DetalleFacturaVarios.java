...
public class DetalleFacturaVarios {
	private int id;
	...
	public DetalleFacturaVarios() {
		super();
	}

	public DetalleFacturaVarios(int id, String descripcion, int cantidad, BigDecimal precio_unitario,
