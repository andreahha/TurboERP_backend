...
public class Proyecto {
	...
	private float mes_estimado;
	private float año_estimado;
	private int activo;
	...
	public Proyecto(int id, int numero, String iniciales, int anio, Date fecha_alta, String descripcion, int monto,
			String moneda, float mes_estimado, float año_estimado, int activo, String status, Date fecha_baja,
	...
	public float getMes_estimado() {
		return mes_estimado;
	}

	public void setMes_estimado(float mes_estimado) {
		this.mes_estimado = mes_estimado;
	}

	public float getAño_estimado() {
		return año_estimado;
	}

	public void setAño_estimado(float año_estimado) {
		this.año_estimado = año_estimado;
	}
