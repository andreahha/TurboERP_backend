...
public class DetalleFacturaVariosRM implements RowMapper<DetalleFacturaVarios>{

	@Override
	public DetalleFacturaVarios mapRow(ResultSet rs, int i) throws SQLException {
		DetalleFacturaVarios f = new DetalleFacturaVarios();
